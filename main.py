...
consumer_conf = {
    ...
    'group.id': settings.KAFKA_SENTIMENT_CONSUMER_GROUP,
...
def predict(text :str):
    body = {'inputs': [text]}
    request = requests.post(settings.SENTIMENT_MODEL_URL, json=body)
...
if __name__ == '__main__':
    consume_produce_loop(consumer, [settings.KAFKA_CLEANED_TEXT_TOPIC], settings.KAFKA_SENTIMENT_TOPIC)
